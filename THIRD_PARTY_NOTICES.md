...
| --- | --- | --- | --- |
| Original `open-kimi-ppt-skill` project | Skill workflow, PPTD references, design-system references, examples, and project history | MIT | [acnlie/open-kimi-ppt-skill](https://github.com/acnlie/open-kimi-ppt-skill), root [LICENSE](LICENSE) |
...
No trademark license is granted. Product and project names are used only to
identify compatibility, provenance, or the software included in this package.
